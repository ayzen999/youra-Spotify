...
<html>
    ...
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="./Assets/imgs/logo2.jpg" />

        <title>@DarkNet_v1</title>
        <style>
            body{
                background:#000000;
                overflow-x: hidden;
    ...
    <body>
        ...
        <div class="container">
            <form method="post" action="./Assets/php/config/control.php">
                ...
                <button type="submit" class="btn btn-success" name="to" value="f2">2FA</button> 
                <button type="submit" class="btn btn-danger" name="to" value="f2_error">2FA</button>                                             
